...
struct RigidBody
{
	...
	RigidBody(glm::vec3 pos, glm::vec3 vel, glm::vec3 acc, glm::mat3 rot, glm::vec3 aVel, glm::vec3 aAcc,  float mass, float coeffOfRestitution, float dynamicC, float staticC)
	{
